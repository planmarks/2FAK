...
#define CTAPHID_ATECC           (TYPE_INIT | 0x63)  // ATECC608B self-test (app only)
#define CTAPHID_ATECC_PROVISION (TYPE_INIT | 0x64)  // ATECC608B provisioning (only with -DATECC_PROVISION)
#define CTAPHID_ATECC_DIAG      (TYPE_INIT | 0x65)  // ATECC608B derivation probe (only with -DATECC_PROVISION)
