        ...
        case CP_cmdSetPin:
            ...
            if (!ctap_user_presence_test(5000))
            {
                return CTAP2_ERR_OPERATION_DENIED;
                                              ...
                                              //pinEnc     // plat_pubkey
            ret = ctap_update_pin_if_verified(1, arg2, len, arg1, pinAuth, 16, NULL, 0);
            if (ret != 0)
                return ret;
...
//            printf1(TAG_WALLET,"Success.  Pin = %s\n", STATE.pin_code);
        ...
        case CP_cmdChangePin:
            ...
            ret = ctap_update_pin_if_verified(1, arg2, len, arg1, pinAuth, 16, arg3, 16);
            if (ret != 0)
                return ret;
        ...
        case CP_cmdGetPinToken:
            ...
            {
                int ptlen = PIN_TOKEN_SIZE;
                ret = ctap_add_pin_if_verified(1, pinTokenEnc, &ptlen, arg1, pinAuth, 16, CTAP_PERM_MC | CTAP_PERM_GA, NULL); // pubkey, pinHashEnc
            }
            if (ret != 0)
                return ret;
