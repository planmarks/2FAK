...
void init_gpio(void)
{
  ...
  // 2FA Key board: status LED D1 on PB3 (single GPIO, active-high).
  // GPIOB clock is enabled above. PB3 defaults to JTDO/TRACESWO after reset;
  // we use SWD (PA13/PA14) with SWO unconnected, so PB3 is free as GPIO.
